    ...
    .then(users => {
        ...
        if (loggedInUser) {
            ...
            <p><strong>Great Learning Website Link :</strong>
                <a href="https://gat.openinapp.co/GreatLearning" class="text-cc1">Click Here To Great Learning Website Link</a>
            </p>
            <p><strong>Great Learning Course Link :</strong>
                <a href="https://gat.openinapp.link/GreatLearningCertificate" class="text-cc1">Click Here To Great Learning Course Link</a>
            </p>
